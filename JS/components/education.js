        ...
        <div class="education__Container"> 
            <div class="education__part" id="education__left">
                    ...
                    <div class="education__left__container education__container__background">
                        ...
                        <h2 class="introduction__string education__container__background">[Licenciatura en Lenguas
                ...
                <div class="education__left__container education__container__background">
                    <h2 class="introduction__string education__container__background">[Entrenamiento Integral en
                ...
                <div class="education__left__container education__container__background">
                    <h2 class="introduction__string education__container__background">[Diplomado en Habilidades
                        Profesionales]</h2>
                    <h3 class="education__container__background education__container__textColor">//Universidad
                        Industrial de Santander</h3>
                ...
                <div class="education__left__container education__container__background">
                    ...
                    <div class="stack__container education__container__background">
                        ...
                        <div class="education__container__background stack__item"><img
                                ...
                                alt="">git</div>
                        <div class="education__container__background stack__item"><img
                                class="education__container__background education__icon" src="./media/icons/physics.png"
                                alt="">reactjs</div>
                    </div>
                </div>
